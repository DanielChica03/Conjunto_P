...
<form action="{{ route('ventas.store') }}" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.01" min="0" max="100" class="form-control" id="descuento" name="descuento" value="{{ old('descuento', 0) }}">
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function calcularTotales() {
        ...
        // Aplica el descuento como porcentaje
        totalInput.value = (total * (1 - descuento / 100)).toFixed(2);
    }
